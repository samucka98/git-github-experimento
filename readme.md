...
>As { } são para indicar um nome que o usuário irá dar ou variavel.
...
Pode ser criados arquivos fazer qualquer coisa que isso terá nenhuma influencia sobre o projeto geral.
...
### Mesclar a linha do tempo alternativa com a principal.
